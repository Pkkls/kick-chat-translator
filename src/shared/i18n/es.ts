...
export const es: Record<string, string> = {
  ...
  '"Reset all settings" restores defaults. Use it if translations stop appearing because a filter (channel allowlist or source-language allowlist) was left active.': '"Restablecer todos los ajustes" recupera los valores predeterminados. Úsalo si las traducciones dejan de aparecer porque quedó activo un filtro (lista de canales permitidos o lista de idiomas de origen permitidos).',
  ...
  'Translate what you type before sending. A live preview appears above the chat box; click it to drop the translation in. Uses the same engine and providers as incoming chat.': 'Traduce lo que escribes antes de enviarlo. Aparece una vista previa en vivo encima del cuadro de chat; haz clic para insertar la traducción. Usa el mismo motor y los mismos proveedores que el chat entrante.',
  Engine: 'Motor',
  ...
  'Channel allowlist (only translate on these)': 'Canales permitidos (traducir solo en estos)',
  'Channel blocklist': 'Canales bloqueados',
  'User blocklist': 'Usuarios bloqueados',
  ...
  'Enable': 'Activar',
  'Keep original': 'Ver original',
  'Language badge': 'Ver idioma',
  ...
  'The recommended style is the most tested. The other three may still change.': 'El estilo recomendado es el más probado. Los otros tres aún pueden cambiar.',
  ...
  'Kick Chat Translator reads chat as it arrives and puts a translation under each message in the language you read. It also translates what you type before you send it. No account, no tracking, open source.': 'Kick Chat Translator lee el chat segun llega y pone una traduccion bajo cada mensaje, en el idioma que lees. Tambien traduce lo que escribes antes de enviarlo. Sin cuenta, sin rastreo, codigo abierto.',
  'Version': 'Version',
  'Languages': 'Idiomas',
  'Providers ready': 'Proveedores listos',
  'Messages translated': 'Mensajes traducidos',
  'How a message becomes a translation': 'Como un mensaje se convierte en traduccion',
  'The message is read from the page, emotes and links set aside.': 'El mensaje se lee de la pagina, emotes y enlaces apartados.',
  'Its language is worked out on the spot, from the script and the words it uses. This answer decides everything after it.': 'Su idioma se determina alli mismo, por la escritura y las palabras que usa. Esa respuesta decide todo lo demas.',
  'Filters run: already in your language, too short, a bot, a language you did not pick.': 'Pasan los filtros: ya en tu idioma, demasiado corto, un bot, un idioma que no elegiste.',
  'The cache is asked first, so the same message is never paid for twice.': 'Primero se consulta la cache, para no pagar dos veces el mismo mensaje.',
  'Otherwise the first available provider in your chain answers, or the on-device engine if you enabled it.': 'Si no, responde el primer proveedor disponible de tu cadena, o el motor local si lo activaste.',
  'The Activity tab shows what each of these steps did for you.': 'La pestana Actividad muestra lo que cada paso hizo por ti.',
  'What changed in this version': 'Que cambio en esta version',
  'entries': 'entradas',
  'of the cap': 'del limite',
  'oldest kept in memory:': 'la mas antigua en memoria:',
  'requests have gone through this limit': 'peticiones han pasado por este limite',
  'never reached so far': 'nunca alcanzado hasta ahora',
  'messages held back by this cap': 'mensajes retenidos por este limite',
  'Maintenance': 'Mantenimiento',
  'Nothing picked: every language is translated.': 'Nada marcado: se traducen todos los idiomas.',
  'picked: everything else is left alone.': 'marcados: todo lo demas se deja en paz.',
  'channels you have watched': 'canales que has visto',
  'Only here': 'Solo aqui',
  'Never here': 'Nunca aqui',
  'No key yet, so DeepL is skipped and the chain moves on.': 'Aun sin clave, asi que DeepL se omite y la cadena sigue.',
  'used this month': 'usado este mes',
  'messages translated': 'mensajes traducidos',
  'served from cache': 'servidos por la cache',
