...
export const fr: Record<string, string> = {
  ...
  'Tab swaps my message for its translation (off = Ctrl/Cmd+Enter only)': 'Tab remplace mon message par sa traduction (sinon Ctrl/Cmd+Entree seul)',
  'Density': 'Densité',
  'Compact': 'Serré',
  'Normal': 'Normal',
  'Roomy': 'Aéré',
  'Accent colour': "Couleur d'accent",
  'Kick green': 'Vert Kick',
  'Cyan': 'Cyan',
  'Violet': 'Violet',
  'Amber': 'Ambre',
  'Chat theme': 'Thème du chat',
  'Follow Kick': 'Suivre Kick',
  'Always dark': 'Toujours sombre',
  'Always light': 'Toujours clair',
  'Remember a reading language per channel': 'Retenir une langue de lecture par chaîne',
  'Kick Chat Translator reads chat as it arrives and puts a translation under each message in the language you read. It also translates what you type before you send it. No account, no tracking, open source.': "Kick Chat Translator lit le chat au fil de l'eau et pose une traduction sous chaque message, dans la langue que tu lis. Il traduit aussi ce que tu ecris avant que tu l'envoies. Pas de compte, pas de pistage, code ouvert.",
  'Version': 'Version',
  'Languages': 'Langues',
  'Providers ready': 'Fournisseurs prets',
  'Messages translated': 'Messages traduits',
  'How a message becomes a translation': 'Comment un message devient une traduction',
  'The message is read from the page, emotes and links set aside.': 'Le message est lu depuis la page, emotes et liens mis de cote.',
  'Its language is worked out on the spot, from the script and the words it uses. This answer decides everything after it.': "Sa langue est etablie sur place, d'apres l'ecriture et les mots employes. Cette reponse decide de tout le reste.",
  'Filters run: already in your language, too short, a bot, a language you did not pick.': "Les filtres passent : deja dans ta langue, trop court, un bot, une langue que tu n'as pas choisie.",
  'The cache is asked first, so the same message is never paid for twice.': "Le cache est interroge d'abord, pour ne jamais payer deux fois le meme message.",
  'Otherwise the first available provider in your chain answers, or the on-device engine if you enabled it.': "Sinon le premier fournisseur disponible de ta chaine repond, ou le moteur embarque si tu l'as active.",
  'The Activity tab shows what each of these steps did for you.': "L'onglet Activite montre ce que chacune de ces etapes a fait pour toi.",
  'What changed in this version': 'Ce qui a change dans cette version',
  'entries': 'entrees',
  'of the cap': 'du plafond',
  'oldest kept in memory:': 'la plus vieille en memoire :',
  'requests have gone through this limit': 'requetes sont passees par cette limite',
  'never reached so far': "jamais atteint jusqu'ici",
  'messages held back by this cap': 'messages retenus par ce plafond',
  'Maintenance': 'Maintenance',
  'Nothing picked: every language is translated.': 'Rien de coche : toutes les langues sont traduites.',
  'picked: everything else is left alone.': 'cochees : tout le reste est laisse tranquille.',
  'channels you have watched': 'chaines que tu as regardees',
  'Only here': 'Seulement ici',
  'Never here': 'Jamais ici',
  'No key yet, so DeepL is skipped and the chain moves on.': 'Pas encore de cle, donc DeepL est saute et la chaine continue.',
  'used this month': 'utilise ce mois-ci',
  'messages translated': 'messages traduits',
