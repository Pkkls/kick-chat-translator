...
export const tr: Record<string, string> = {
  ...
  'Kick Chat Translator reads chat as it arrives and puts a translation under each message in the language you read. It also translates what you type before you send it. No account, no tracking, open source.': 'Kick Chat Translator sohbeti geldikçe okur ve her mesajın altına senin okuduğun dilde bir çeviri koyar. Yazdıklarını da göndermeden önce çevirir. Hesap yok, takip yok, açık kaynak.',
  'Version': 'Sürüm',
  'Languages': 'Diller',
  'Providers ready': 'Hazır sağlayıcılar',
  'Messages translated': 'Çevrilen mesajlar',
  'How a message becomes a translation': 'Bir mesaj nasıl çeviriye dönüşür',
  'The message is read from the page, emotes and links set aside.': 'Mesaj sayfadan okunur, emoteler ve bağlantılar bir kenara alınır.',
  'Its language is worked out on the spot, from the script and the words it uses. This answer decides everything after it.': 'Dili oracakta, yazı sistemi ve kullanılan kelimelerden belirlenir. Bu cevap sonraki her şeyi belirler.',
  'Filters run: already in your language, too short, a bot, a language you did not pick.': 'Filtreler çalışır: zaten senin dilinde, çok kısa, bir bot, seçmediğin bir dil.',
  'The cache is asked first, so the same message is never paid for twice.': 'Önce önbelleğe sorulur, aynı mesaj için iki kez ödenmesin diye.',
  'Otherwise the first available provider in your chain answers, or the on-device engine if you enabled it.': 'Aksi halde zincirindeki ilk uygun sağlayıcı ya da açtıysan cihaz içi motor yanıtlar.',
  'The Activity tab shows what each of these steps did for you.': 'Etkinlik sekmesi bu adımların senin için ne yaptığını gösterir.',
  'What changed in this version': 'Bu sürümde ne değişti',
  'entries': 'kayıt',
  'of the cap': 'sınırın',
  'oldest kept in memory:': 'bellekteki en eski:',
  'requests have gone through this limit': 'istek bu sınırdan geçti',
  'never reached so far': 'şimdiye dek hiç ulaşılmadı',
  'messages held back by this cap': 'mesaj bu sınırla tutuldu',
  'Maintenance': 'Bakım',
  'Nothing picked: every language is translated.': 'Hiçbir seçim yok: tüm diller çevrilir.',
  'picked: everything else is left alone.': 'seçili: geri kalanı rahat bırakılır.',
  'channels you have watched': 'izlediğin kanallar',
  'Only here': 'Sadece burada',
  'Never here': 'Burada asla',
  'No key yet, so DeepL is skipped and the chain moves on.': 'Henüz anahtar yok, bu yüzden DeepL atlanır ve zincir devam eder.',
  'used this month': 'bu ay kullanılan',
  'messages translated': 'mesaj çevrildi',
  'served from cache': 'önbellekten geldi',
