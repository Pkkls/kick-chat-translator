...
export function AboutSection() {
  ...
  return (
    <section class="kt-card space-y-4">
      ...
      <div>
        <h3 class="text-xs uppercase tracking-wider text-kick-muted mb-1">
          {t('How translation happens')}
        </h3>
        <ol class="list-decimal list-inside text-sm text-kick-muted space-y-1">
          ...
          <li>
            {t('Each chat message is parsed; emotes and links are stripped before translation.')}
          </li>
